...
#average global sales across all 20 games
total = 0
for sales in video_game_sales :
    total = total + sales[GLOBAL_SALES]

avg_global_sales = total/total_games
print(f"The average total of global sales across {total_games} games - {avg_global_sales}.")
