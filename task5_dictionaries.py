...
for game in video_game_sales:
    if game[GENRE] in sales_by_genre:
        sales_by_genre[game[GENRE]] = sales_by_genre[game[GENRE]] + game[GLOBAL_SALES]
    else:
        sales_by_genre[game[GENRE]] = game[GLOBAL_SALES]
print(sales_by_genre)

#Games per publisher in dataset.
games_per_publisher = {}
for game in video_game_sales:
...
#Details of #1 ranked game.
top_game = {}
top_game['name'] = video_game_sales[0][NAME]
top_game['year'] = video_game_sales[0][YEAR]
top_game['genre'] = video_game_sales[0][GENRE]
top_game['publisher'] = video_game_sales[0][PUBLISHER]
top_game['global_sales'] = video_game_sales[0][GLOBAL_SALES]
