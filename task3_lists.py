...
game_names = []
for names in video_game_sales:
   game_names.append(names[1])
print(game_names)
               
#add new game to game sales list and print length
...
#tuples are immutable and cannot be changed. This will display the fixed values of the current dataset.
print(dataset_info)
